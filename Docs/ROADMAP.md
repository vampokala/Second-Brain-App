...
- RAG generation and response validation

### Phase 4 (completed)

- Citation tracker + verifier modules
- FastAPI query endpoints
- Streamlit query UI with per-request provider/model switching
- Streamlit ingest tab with upload + ingest trigger
